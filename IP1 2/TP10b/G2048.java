...
public class G2048 {
    ...
    */
    ...
    // La grille
    public static int[][] board; // c la variable gloabal board
    ...
    public static int[] slideLeftNoMerge (int[] t){
      int[] tab=newEmptyRow();
      int res=0;
      for (int i=0;i<t.length;i++){
        if (t[i]!=0){
    ...
    public static int[] slideLeftAndMerge (int[] t){
      int[] tab=newEmptyRow();
      int[] t1=slideLeftNoMerge(t);
      int r=0;
